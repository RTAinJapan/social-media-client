...
const envSchema = z.object({
	...
	DATABASE_URL: z
		.string()
		.default("postgres://admin:admin@localhost:5432/postgres"),
	DATABASE_URL_SECRET_ID: z.string().optional(),

	TWITTER_USERNAME: z.string().default("rtainjapan"),
	TWITTER_PASSWORD: z.string().optional(),
	TWITTER_PASSWORD_SECRET_ID: z.string().optional(),
});
